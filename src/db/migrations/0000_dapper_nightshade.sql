...
CREATE TABLE "messages" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "messages_content_check" CHECK (is_deleted = true OR length(TRIM(BOTH FROM content)) > 0)
);
--> statement-breakpoint
...
ALTER TABLE "friend_nicknames" ADD CONSTRAINT "friend_nicknames_target_id_users_id_fk" FOREIGN KEY ("target_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "muted_conversations" ADD CONSTRAINT "muted_conversations_conversation_id_conversations_id_fk" FOREIGN KEY ("conversation_id") REFERENCES "public"."conversations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "user_streaks" ADD CONSTRAINT "user_streaks_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "idx_blocked_users_blocker_id" ON "blocked_users" USING btree ("blocker_id" uuid_ops);--> statement-breakpoint
CREATE INDEX "idx_blocked_users_blocked_id" ON "blocked_users" USING btree ("blocked_id" uuid_ops);--> statement-breakpoint
...
CREATE INDEX "idx_messages_conversation_id_created_at" ON "messages" USING btree ("conversation_id" uuid_ops,"created_at" timestamptz_ops);--> statement-breakpoint
...
CREATE INDEX "idx_post_reactions_post_id_created_at" ON "post_reactions" USING btree ("post_id" uuid_ops,"created_at" timestamptz_ops);--> statement-breakpoint
CREATE INDEX "idx_post_views_post_id_viewed_at" ON "post_views" USING btree ("post_id" uuid_ops,"viewed_at" timestamptz_ops);--> statement-breakpoint
...
CREATE INDEX "idx_posts_author_created_at" ON "posts" USING btree ("author_id" uuid_ops,"created_at" timestamptz_ops);--> statement-breakpoint
